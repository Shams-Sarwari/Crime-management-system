...
urlpatterns = [
    ...
    path('change_staff_avatar/<uuid:pk>/', views.change_staff_avatar, name='change-staff-avatar'),
    path('change_staff_status/<uuid:pk>/', views.change_staff_to_admin, name='change-to-admin'),
    path('deactive_staff/<uuid:pk>/', views.deactive_staff,name='deactive-staff'),
